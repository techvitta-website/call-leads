    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 p-2 sm:p-4 lg:p-8 pt-16 sm:pt-16 lg:pt-8 overflow-auto bg-slate-50">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-1">Receipts</h1>
            <p className="text-sm text-slate-600">Record incoming payments against invoices.</p>
          </div>
        </div>
        ...
        <Card className="p-6 text-center space-y-3">
          ...
          <h2 className="text-lg font-semibold text-slate-900">Receipts module</h2>
          <p className="text-sm text-slate-600">
            Capture customer payments and reconcile invoices. Coming soon—your receipts will be displayed here once added.
          </p>
